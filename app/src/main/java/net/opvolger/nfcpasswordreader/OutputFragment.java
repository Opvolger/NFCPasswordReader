...
public class OutputFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        Bitmap foto = ((MainActivity)this.getActivity()).currentBitmap;
        if (foto != null && imageview != null) {

            imageview.setImageBitmap(foto);
            ((TextView)view.findViewById(R.id.naam)).setText(((MainActivity)this.getActivity()).currentName);
        }
        return view;
    }
